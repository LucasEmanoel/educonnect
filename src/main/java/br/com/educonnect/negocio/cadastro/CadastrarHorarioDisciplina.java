...
import br.com.educonnect.negocio.cadastro.HorarioIndisponivelException;

@Service
public class CadastrarHorarioDisciplina implements ICadastroDisciplina {
	...
	@Override
	public Disciplina cadastrarDisciplina(long id, String nome) {
